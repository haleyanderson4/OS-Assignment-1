...
public class Main
{
  ...
  public static void main(String[] args)
  {
    try
    {
      ...
      thread1(sudoku, repeats, missing);
      thread2(sudoku, repeats, missing);
      ...
      {
        combine(sudoku, repeats, missing);
  ...
  public static void thread1(int[][] sudoku, ArrayList<String> repeats, ArrayList<String> missing) //thread 1, row by row
  {
  ...
  public static void thread2(int[][] sudoku, ArrayList<String> repeats, ArrayList<String> missing) //thread 2, column by column
  {
    String[] sudokuLine = new String[9];
  ...
  public static void combine(int[][] sudoku, ArrayList<String> repeats, ArrayList<String> missing) //combines problem lists into actionable items & solves
  {
